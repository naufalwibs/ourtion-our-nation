...
function CountryDetail() {
  ...
  const loadingDetail = useSelector(
    (state) => state.countriesReducer.loadingDetail
  );
  const errorDetail = useSelector(
    (state) => state.countriesReducer.errorDetail
  );
        ...
        <div className="container mt-5">
          <div className="row pt-5">
            <div className="card col-lg-4 bg-transparent border-fix border-fix">
              ...
              <img
                className="rounded nation-flag"
                src={country[0].flag}
                alt=""
                width="100%"
              />
              <p
                onClick={(event) => addToFavorite(event, country)}
                className="btn btn-outline-dark mt-3"
              >
                <i className="fas fa-flag"></i> Favorite{" "}
              </p>
            ...
            <div className="card bg-transparent col-lg-8 border-fix">
              ...
              <div className="row">
                <div className="col-lg-3 mb-3">
                  <div className="card-box rounded shadow-sm py-5 px-4 height-card">
                    <p className="text-center">
                      <i className="fas fa-passport icon-detail"></i>
                    </p>
                    <h5 className="mb-0 text-center">Also Know As</h5>
                    <p className="small text-center">
                      {country[0].altSpellings.join(", ")}
                    </p>
                  </div>
                </div>
                ...
                <div className="col-lg-3 mb-3">
                  <div className="card-box rounded shadow-sm py-5 px-4 height-card">
                    ...
                    <h5 className="mb-0 text-center">Continent</h5>
                    <p className="small text-center">
                      {country[0].region}, {country[0].subregion}
                    </p>
                  </div>
                </div>
                ...
                <div className="col-lg-3 mb-3">
                  <div className="card-box rounded shadow-sm py-5 px-4 height-card">
                    ...
                    <h5 className="mb-0 text-center">Capital</h5>
                    <p className="small text-center">{country[0].capital}</p>
                  </div>
                </div>
                ...
                <div className="col-lg-3 mb-3">
                  <div className="card-box rounded shadow-sm py-5 px-4 height-card">
                    ...
                    <h5 className="mb-0 text-center">Currencies</h5>
                    <p className="small text-center">
                      {country[0].currencies[0].code},{" "}
                      {country[0].currencies[0].name}, Symbol:{" "}
                ...
                <div className="col-lg-3 mb-3">
                  <div className="card-box rounded shadow-sm py-5 px-4 height-card">
                    ...
                    <h5 className="mb-0 text-center">Province (Gini)</h5>
                    <p className="small text-center">
                      Province: {country[0].gini}, area covered:{" "}
                      {new Intl.NumberFormat("de-DE").format(country[0].area)}{" "}
                      km²
                    </p>
                  </div>
                </div>
                ...
                <div className="col-lg-3 mb-3">
                  <div className="card-box rounded shadow-sm py-5 px-4 height-card">
                    ...
                    <h5 className="mb-0 text-center">Population</h5>
                    <p className="small text-center">
                ...
                <div className="col-lg-3 mb-3">
                  <div className="card-box rounded shadow-sm py-5 px-4 height-card">
                    ...
                    <h5 className="mb-0 text-center">Language</h5>
                    <p className="small text-center">
          ...
          <MapContainer
            id="map"
            center={[country[0].latlng[0], country[0].latlng[1]]}
            zoom={5}
